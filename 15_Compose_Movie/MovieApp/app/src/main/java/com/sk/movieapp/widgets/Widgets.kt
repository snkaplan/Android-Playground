package com.sk.movieapp.widgets
        ...
        Row(
            ...
            Column(modifier = Modifier.padding(4.dp)) {
                ...
                AnimatedVisibility(visible = expanded) {
                    Column {
                        Divider()
                        MovieRowExpandedInfo("Plot", movie.plot)
                        MovieRowExpandedInfo("Director", movie.director)
                        MovieRowExpandedInfo("Actors", movie.actors)
                        MovieRowExpandedInfo("Rating", movie.rating)
                    }
                }
                Icon(
...
@Composable
fun MovieRowExpandedInfo(title: String, description: String) {
